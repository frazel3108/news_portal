...
$allNewsI = selectALL('news', null, [], $limit, 'mainNews', true, $offset);
?>
                    ...
                    <div class="table-wrapper table-responsive">
                        <table class="table table-hover bg-white">
                            ...
                            <tr>
                                ...
                                <th scope="col">
                                    <h6 class="text-center">Действие</h6>
                                </th>
                            </tr>
                            </thead>
                            <tbody>
                            <?php for ($i = 0; $i < count($allNewsI); $i++) {
                                ...
                                ?>
                                <tr>
                                    <form action="../controllers/change-mainNews.php" method="post">
                                        ...
                                        <td class="min-width">
                                            ...
                                            <?php if ($allNewsI[$i]['mainNews'] == 1) { ?>
                                                ...
                                                <div class="form-check form-switch toggle-switch">
                                                    <input type="hidden" name="main[<?= $allNewsI[$i]['id'] ?>]"
                                                           value="0"/>
                                                    <input class="form-check-input"
                                                           name="main[<?= $allNewsI[$i]['id'] ?>]" type="checkbox"
                                                           checked>
                                                </div>

                                            <?php } else if (countMain()['main'] < 3) { ?>
                                                <div class="form-check form-switch toggle-switch">
                                                    <input class="form-check-input"
                                                           name="main[<?= $allNewsI[$i]['id'] ?>]" type="checkbox">
                                                </div>
                                        ...
                                        <td class="min-width">
                                            <div class="action">
                                                ...
                                                <a href="/app/controllers/delete-news.php?id=<?= $allNewsI[$i]['id'] ?>"
                                                   class="text-danger">
                                                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"
