    ...
    <section class="section">
        <div class="container-fluid">
            ...
            <div class="form-elements-wrapper">
                <form action="../controllers/add-news.php" method="post" enctype="multipart/form-data">
                    <div class="row">
                        <div class="card-style mb-30">
                            ...
                            <div class="input-style-1">
                                ...
                                <textarea placeholder="Основной текст статьи" name="description" rows="5"></textarea>
                            </div>
                            <div class="mb-3">
